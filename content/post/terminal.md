---
layout: post
title: Dominando Terminal Linux do zero
description: Dominando linha de comando UNIX. Conteúdo perfeito para quem quer conhecer, aprender e/ou relembrar. Dando uma leve introdução sobre Linux, Terminal e como usá-lo via windows (WSL).
tags: ["Linux", "Terminal", "WSL"]
